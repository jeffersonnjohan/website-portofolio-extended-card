...
<div class="w-full h-[400px] text-center text-black font-poppins py-10">
    <h1 class="text-3xl mb-5 font-bold">Apa aja sih hobi saya?</h1>
    ...
    <div class="mt-10 w-[620px] m-auto flex justify-between text-brown1">
        ...
        <a href="#catur">
            <div class="w-[200px] h-52 bg-brown4 rounded-md flex flex-col items-center hover:border-2 box-border border-brown1 hover:scale-105 hover:cursor-pointer active:border-red-500">
                ...
                <h2 class="font-bold text-xl">Catur</h2>
            </div>
        </a>
        {{-- Hobi 2 --}}
        <a href="#bulutangkis">
            <div class="w-[200px] h-52 bg-brown4 rounded-md flex flex-col items-center hover:border-2 box-border border-brown1 hover:scale-105 hover:cursor-pointer active:border-red-500">
                ...
                <h2 class="font-bold text-xl">Bulutangkis</h2>
            </div>
        </a>
        {{-- Hobi 3 --}}
        <a href="#memasak">
            <div class="w-[200px] h-52 bg-brown4 rounded-md flex flex-col items-center hover:border-2 box-border border-brown1 hover:scale-105 hover:cursor-pointer active:border-red-500">
                ...
                <h2 class="font-bold text-xl">Memasak</h2>
            </div>
        </a>
    </div>
</div>
...
<div id="bulutangkis" class="w-full text-center text-black font-poppins mt-16">
    <div class="w-4/5 m-auto border-t-2">
        <h1 class="text-3xl mt-16 mb-7 font-bold">Bulutangkis</h1>
        <p class="mb-5 text-lg px-16 text-justify">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Ex ullam ipsam tenetur cum dolorem incidunt nostrum autem aut, ipsa veniam voluptatibus. Asperiores porro dolore vitae repellat sed dolorem! Ratione animi, provident doloribus nesciunt molestias recusandae cum tempore similique aut! Rerum.</p>
        <img src="https://source.unsplash.com/600x300?background-pink" alt="Image 1" class = "w-3/5 m-auto mb-10">
        <p class="mb-5 text-lg px-16 text-justify">Lorem ipsum dolor sit amet consectetur adipisicing elit. Minus nihil ab qui pariatur dolorum animi eius, deserunt magni alias suscipit? Provident eaque distinctio aliquam, rerum delectus sit tempore deleniti minima maiores dolorum ab possimus inventore. Ipsam sequi illum, accusantium sunt ipsa, dolores beatae quidem eos dicta animi doloremque eius facilis..</p>
    </div>
...
<div id="memasak" class="w-full text-center text-black font-poppins my-16">
    <div class="w-4/5 m-auto border-t-2">
        <h1 class="text-3xl mt-16 mb-7 font-bold">Memasak</h1>
        <p class="mb-5 text-lg px-16 text-justify">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Ex ullam ipsam tenetur cum dolorem incidunt nostrum autem aut, ipsa veniam voluptatibus. Asperiores porro dolore vitae repellat sed dolorem! Ratione animi, provident doloribus nesciunt molestias recusandae cum tempore similique aut! Rerum.</p>
        <img src="https://source.unsplash.com/600x300?background-pink" alt="Image 1" class = "w-3/5 m-auto mb-10">
        <p class="mb-5 text-lg px-16 text-justify">Lorem ipsum dolor sit amet consectetur adipisicing elit. Minus nihil ab qui pariatur dolorum animi eius, deserunt magni alias suscipit? Provident eaque distinctio aliquam, rerum delectus sit tempore deleniti minima maiores dolorum ab possimus inventore. Ipsam sequi illum, accusantium sunt ipsa, dolores beatae quidem eos dicta animi doloremque eius facilis..</p>
    </div>
