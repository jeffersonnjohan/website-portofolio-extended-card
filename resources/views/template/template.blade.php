...
<body>
    ...
    <div class="navbar w-full h-[500px] bg-cover bg-fixed text-brown1 font-poppins" style="background-image: url('/img/{{ $image }}')">
        ...
        <div class="w-full h-20 flex justify-center sticky top-0">
            ...
            <div class="p-3 text-center"><span class="drop-shadow-[0_2px_6px_rgba(255,255,255,1)] hover:text-brown1 hover:cursor-pointer hover:drop-shadow-[0_2px_6px_rgba(0,0,0,1)] hover:text-white"><a href="/restaurant">Restaurant</a></span> </div>
        </div>
